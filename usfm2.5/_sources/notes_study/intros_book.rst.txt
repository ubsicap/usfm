...
Extended or alternative book introduction text should replace any existing book introduction text from the base scripture translation text. Any USFM identification (metadata) elements (:ref:`\\h <usfmp_h>`, :ref:`\\toc1 <usfmp_toc#>`, :ref:`\\toc2 <usfmp_toc#>`, :ref:`\\toc3 <usfmp_toc#>`), :ref:`main title(s) <usfmp_mt#>`, :doc:`introduction </introductions/index>` elements, and :doc:`table </tables/index>` elements can be included within the extended book introduction.
...
.. code-block:: text
	:name: usfm-study_intros_book_example
...
.. image:: images/usfm-study_intros_book1.jpg
	:width: 250px

**Introduction Section** - Introduction to Mark (GNSB)

.. code-block:: text
	:name: usfm-study_intros_book_example2
...
.. image:: images/usfm-study_intros_book2.jpg
	:width: 250px

**Introduction List** - Introduction to Mark (GNSB)

.. code-block:: text
	:name: usfm-study_intros_book_example3
...
.. image:: images/usfm-study_intros_book3.jpg
	:width: 250px
